...
class NodoTris:
    ...
    def tipo(self):
        ...
        ris=None
        for i in controllo:
            if x[0][0]==i and x[0][1]==i and x[0][2]==i:
                ris=i 
            if x[1][0]==i and x[1][1]==i and x[1][2]==i:
                ris=i
            if x[2][0]==i and x[2][1]==i and x[2][2]==i:
                ris=i
            if x[0][0]==i and x[1][0]==i and x[2][0]==i:
                ris=i
            if x[0][1]==i and x[1][1]==i and x[2][1]==i:#
                ris=i
            if x[0][2]==i and x[1][2]==i and x[2][2]==i:
                ris=i
        
            if x[0][0]==i and x[1][1]==i and x[2][2]==i:
                ris=i
            if x[2][0]==i and x[1][1]==i and x[0][2]==i:
                ris=i
        if ris==None:
            if riso+risx!=9:
                ris='?'
