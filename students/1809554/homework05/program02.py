...
def ai(griglia_corrente, griglia_precedente, x, y, vx, vy, car, verso, startx, starty):
    ...
    global g
    if verso==1 and g==0:
        if griglia_corrente[x+1][y]!='0' and griglia_corrente[x+1][y]!='#':
            if vx!=1:
                ax+=1
            if vy==1:
                ay=ay-1
        elif griglia_corrente[x+1][y+1]!='0' and griglia_corrente[x+1][y+1]!='#':
            if vx!=1:
                ax+=1
            if vy!=1:
                ay+=1
        elif griglia_corrente[x][y+1]!='0' and griglia_corrente[x][y+1]!='#':
            if vx==1:
                ax=-1
            if vy!=1:
                ay+=1
        ...
        return ax,ay
    if verso==1 and g==1:
        if griglia_corrente[x][y+1]!='0' and griglia_corrente[x][y+1]!='#':
            if vy!=1:
                ay+=1
            if vx==1:
                ax=ax-1
            ...
            if vx!=-1:
                ax=ax-1
        elif griglia_corrente[x-1][y]!='0' and griglia_corrente[x-1][y]!='#':
            if vy==1:
                ay=-1
            if vx!=1:
                ax=ax-1
