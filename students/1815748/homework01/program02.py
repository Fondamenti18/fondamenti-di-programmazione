''' In determinate occasioni ci capita di dover scrivere i numeri in letteree, 
...
e restituisce in output una stringa con il numero espresso in letteree

ATTENZIONE: NON USATE lettereE ACCENTATE.
