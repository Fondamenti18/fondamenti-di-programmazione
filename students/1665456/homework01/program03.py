...
def codifica(chiave, testo):
    ...
    for x in chiave2:
        ...
        if (ch.isalpha() and ch.islower() and ch not in stringa):
            stringa.append(ch)
       
    stringa.reverse()
 
    stringaord=deepcopy(stringa)
    ...
    for x in testo:
        ...
        if (x in stringaord):
            ...
            n=stringaord.index(x)
           
            tiesto = tiesto+stringa[n]
...
"""codifica('sim sala Bim!', 'il mare sa di sale')
