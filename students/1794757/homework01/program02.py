...
'''
def conv(n):
    da1a19=["","uno", "due", "tre", "quattro", "cinque","sei", "sette", "otto", "nove", "dieci","undici", "dodici", "tredici","quattordici", "quindici", "sedici", "diciassette", "diciotto", "diciannove"]
    ...
    if n == 0: 
        ...
        if decina != 8:
            a = a + "o"
        return conv(int(n/100)) + a + conv(n%100)
