...
infatti, non elidono la vocale finale. Dunque non scriveremo centuno,  trecentotto ma centouno, 8
trecentootto, ecc...
...
#decine
        ...
        deca=('venti','trenta','quaranta','cinquanta','sessanta','settanta','ottanta','novanta')
        k=n%10
        lettere=deca[int(n/10)-2]
        if k==1 or k==8:
           lettere=lettere[:-1]
