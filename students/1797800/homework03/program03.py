...
def paint(img,color1,color2,setPixels1,setPixels2):
    for p in setPixels1:
        img[p[1]][p[0]] = color1
    for p in setPixels2:
        img[p[1]][p[0]] = color2
...
def ricolora(fname, lista, fnameout):
    ...
    for quadrupla in lista:
        ...
        img = paint(img,quadrupla[2],quadrupla[3],setPixelIntern,setPixelBord)
