...
Il numero "mille" non  numero elide in nessuncomposto la vocale finale; scriveremo 
...
def conv(n):
    if n == 0: 
        ...
        return conv(int(n/1000000))+ \
               "milioni" + conv(n%1000000)
    elif n <= 1999999999:
        return "unmiliardo" + conv(n%1000000000)
    elif n<= 99999999999:
        return conv(int(n/1000000000)) + \
               "miliardi" + conv(n%1000000000) 
    elif n<= 1999999999999:
         return conv(int(n/1000000000000)) + \
               "bilione" + conv(n%1000000000000)
