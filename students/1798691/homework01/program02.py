''' In determinate occasioni ci capita di dover scrivere i numeri in lfe, 
...
e restituisce in output una stringa con il numero espresso in lfe

ATTENZIONE: NON USATE lfE ACCENTATE.
...
def conv(n):
    ...
    if n<= 19:
        ...
        if m != 8:
            lf = lf + "o"
        return conv(n//100)+lf+conv(n%100)
