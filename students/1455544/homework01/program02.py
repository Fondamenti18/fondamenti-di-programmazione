...
def conv(n):
    ...
    if n <= 19:
        ...
        '''decine[int(n / 10) - 2] -> es. 99 -> int 99/10=9 -> 9-2 = 7 -> decine[7]= "novanta"'''
        finale = n % 10
        if finale == 1 or finale == 8:
            lettere = lettere[:-1]
        ...
        if int((n % 100)/10) == 8:
            ...
            lettere = "cento"
        return lettere + conv(n % 100)

    elif n <= 999:
        iniziale = int((n % 100)/10)
        lettere = "cent"
        if iniziale != 8:
            lettere = lettere + "o"
        ...
        return "unmilione" + conv(int(n % 1000000))
